					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								...
								<p><a href="{{ route('customer.shop')}}" class="btn btn-secondary me-2">Shop Now</a><a href="{{ route('customer.index')}}" class="btn btn-white-outline">Explore</a></p>
							</div>
						</div>
